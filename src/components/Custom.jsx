     ...
     <div className='w-full h-auto flex'>
            <div className=' flex flex-col md:flex-row justify-between w-full my-36 mx-8 '>
                <div className='order-1 flex md:order-2 '>
                   <img src={Img} className='w-1/2 md:max-w-xs'/>
                </div>
                <div className='flex flex-col justify-center order-2 md:order-1 bg-[#2e4f21] p-3 rounded-lg mt-5 w-full md:w-1/2 lg:w-1/3'>
