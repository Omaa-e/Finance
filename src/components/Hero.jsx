...
const Hero = () => {
  return (
    <div className='w-full h-full flex bg-[#a0f1bd] rounded-b-xl'>
        <div className=' flex flex-col md:flex-row justify-between w-[100%]  mt-10 my-11 mx-4 md:my-25 md:mx-6 lg:my-25 xl:mx-10 xl:my-26'>
            ...
            <div className='flex flex-col  order-2 md:order-1 md:w-[60%] lg:w-[84%] xl:w-[58%] xl:py-7  '>
                ...
                <p className='mb-11 md:w-78 text-[16px] lg:mb-15 xl:w-full text-[#2e4f21] xl:text-lg leading-5'>Trusted financial guidance for every stage of life and business since 1987</p>
                <div>
                  <Link to="/book">
